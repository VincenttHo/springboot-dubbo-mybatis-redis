...
import java.util.Date;
 ...
 /**
 *
 * @className:com.vincent.po.UserPo
 * @description: User 持久化对象
 *
 * @version:v1.0.0
 * @author: VincentHo
 *
 ...
 * -----------------------------------------------------------------
 *  2017-10-10     VincentHo       v1.0.0        create
 *
 *
 */
public class UserPo implements java.io.Serializable{
	...
	public String toString() {
		return "UserPo [id=" + id + ", mobile=" + mobile + ", gender=" + gender
				+ ", email=" + email + ", status=" + status + ", myDesc="
				+ myDesc + ", age=" + age + ", isAuth=" + isAuth
